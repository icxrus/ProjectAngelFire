...
namespace itsmakingthings_daynightcycle
{
    public class DayNightCycle : MonoBehaviour
    {
        ...
        public Light moonLight; // ✅ Moon light added
        public Transform rotationPivot; // Parent transform for offset control
        public Transform rotationPivotMoon; // Parent transform for offset control
        ...
        private void UpdateLighting()
        {
            ...
            {
                // Smoothly blend the offset between morning and evening values
